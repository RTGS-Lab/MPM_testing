...
class ModelHandler:
    ...
    def run_simulation(self):
        ...
        print(f"Read input files. Found {len(drivers)} timesteps.")
        ...
        print(f"Created plant with {len(plant_simulated.get_resource_pools())} resource pools.")
        ...
        for index, row in drivers.iterrows():
            ...
            if index % 500 == 0:
                print(f"Progress: {index}/{total_steps} timesteps ({index/total_steps*100:.1f}%)")
