...
class CarbonAssimilation:
    ...
    def __init__(self, parameters: Dict[str, Union[float, int, str]]):
    ...
    def sunlit_shaded_photosynthesis(self, environmental_variables: Dict[str, float]) -> Tuple[float, float]:
