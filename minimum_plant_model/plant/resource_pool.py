...
class ResourcePool:
    ...
    """
    def __init__(self, name: str, thermal_time_initiation: float, allocation_priority: int, 
                 max_size: float, initial_size: float, growth_rate: float):
    ...
    def compute_relative_growth_rate(self, RP_thermal_age: float, max_size: float, 
                                     initial_size: float, growth_rate: float) -> float:
